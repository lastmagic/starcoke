      ...
      <div class="pt-5 px-4 px-md-5">
        <div class="py-md-4 py-xl-5 mx-lg-5">
          <div class="portfolio-caption">
            ...
            <div v-else-if="this.$route.params.idolId == '2'" class="text-tiny t_white font-weight-400">I<br>LIKE<br>THE VOICE OF<br>'H.I.M'</div>
            <div v-else-if="this.$route.params.idolId == '3'" class="text-tiny t_white font-weight-400">보라색 사과<br>하늘을 헤엄치는 나무늘보<br>우리는 Atypical</div>
            <div v-else-if="this.$route.params.idolId == '4'" class="text-tiny t_white font-weight-400">우리의 목소리는<br>어떤 악기든 될 수 있죠<br>노래하듯이, 나나 칸타빌레!</div>
            <div v-else-if="this.$route.params.idolId == '5'" class="text-tiny t_white font-weight-400">LIFE IS A JOURNEY,<br>NOT A DESTINATION.</div>
